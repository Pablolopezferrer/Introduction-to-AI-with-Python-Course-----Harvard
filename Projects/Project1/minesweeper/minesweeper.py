...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Iteratively check for new safe cells or mines
        changed = True
        while changed:
            changed = False
            
            # Check for new safe cells or mines in all sentences
            for sentence in self.knowledge:
